...
func main() {
	var (
		...
		iface    = flag.String("iface", "", "name of the public state machine interface type")
	)
	flag.Parse()
	...
	if *iface == "" {
		panic("iface is a required parameter")
	}
...
/*
 * THIS IS AN AUTOMATICALLY GENERATED FILE. DO NOT EDIT THIS FILE MANUALLY.
 */
